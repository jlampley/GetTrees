...
GetTreeFromOpenTree_exercise <- function() {
	...
	# Figure out the id used for Anolis in Open Tree's database
 	# OTT: 5342306 this is the Open Tree ID for Anolis -jl
	...
	#Everything works up until this point.  There is something wrong with the rest
	#of this code - maybe a windows issue?? - jl.
	...
	anolis.study1.metadata <- get_study_meta(anolis.studies.ids)
